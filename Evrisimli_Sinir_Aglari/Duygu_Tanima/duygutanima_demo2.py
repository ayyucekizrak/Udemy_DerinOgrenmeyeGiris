...
Original file is located at
    https://colab.research.google.com/drive/1BBanVL_9mBXv9zeE9wk2aXzvs-WZtUBH
...
!ls 'drive/DuyguTanima/data/emotion_models/'

import sys
sys.path.insert(0, 'drive/DuyguTanima/')
