...
import os
os.chdir("/content/drive/Udemy_DerinOgrenmeyeGiris/Evrisimli_Sinir_Aglari/Nesne_Tanima")
!pwd
...
import os
os.chdir("/content/drive/Udemy_DerinOgrenmeyeGiris/Evrisimli_Sinir_Aglari/Nesne_Tanima/images")
!pwd
